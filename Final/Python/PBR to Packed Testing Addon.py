...
#Define class for Bakign the ARM Map:
...
class QuickUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.operator(BakeColorMapOperator.bl_idname, text="Setup Convert")
...
classes = (BakeColorMapOperator, SetupConvertOperator, QuickUI)
